export const i18n = {
  ...
  zh: {
    ...
    controlCenter:
      '全新设计的控制中心、任务栏和通知中心，通过更合理的界面空间布局，提高了使用效率。拟物化设计使图标更加直观易懂。QML的重构不仅减少了桌面对系统资源的占用，还显著提升了运行和响应速度，为用户提供更加流畅的体验。',
    ...
    threeFingers: '三指',
    fourFingers: '四指',
    windowDesc: '长按拖动窗口，上下滑动完成窗口大小切换',
    faster: '更快',
    windowRender: '渲染性能提升',
    efficient: '更流畅',
    graphicsRender: '动画流畅度提升',
    ...
    developerEnvironment:
      '支持 Ubuntu、Debian、Arch linux、Fedora系统，商店一键安装，可通过启动器任务栏一键快速启动子系统',
